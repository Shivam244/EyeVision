      ...
      List<ChartItemLogmar> chartItemsList = [
        ...
        ChartItemLogmar(
            ...
            rotations:
                enableRotation ? [0, 180, 180, 90, 0] : [-1, -1, -1, -1, -1],
            image: image,
            imageSize: calculatePixel(int.parse(distance), '6/48'),
            language: widget.image),
        ChartItemLogmar(
            textLeft: '6/38',
            textRight: '0.8',
            rotations:
                enableRotation ? [0, 180, 180, 90, 0] : [-1, -1, -1, -1, -1],
            image: image,
            imageSize: calculatePixel(int.parse(distance), '6/38'),
            language: widget.image),
        ChartItemLogmar(
            textLeft: '6/30',
            textRight: '0.7',
            rotations:
                enableRotation ? [0, 180, 180, 90, 0] : [-1, -1, -1, -1, -1],
            image: image,
            imageSize: calculatePixel(int.parse(distance), '6/30'),
            language: widget.image),
        ChartItemLogmar(
            textLeft: '6/24',
            textRight: '0.6',
        ...
        ChartItemLogmar(
            ...
            rotations:
                enableRotation ? [0, 180, 180, 90, 0] : [-1, -1, -1, -1, -1],
            image: image,
            imageSize: calculatePixel(int.parse(distance), '6/19'),
            language: widget.image),
        ChartItemLogmar(
            textLeft: '6/15',
            textRight: '0.4',
            rotations:
                enableRotation ? [0, 180, 180, 90, 0] : [-1, -1, -1, -1, -1],
            image: image,
            imageSize: calculatePixel(int.parse(distance), '6/15'),
            language: widget.image),
        ChartItemLogmar(
            textLeft: '6/12',
            textRight: '0.3',
        ...
        ChartItemLogmar(
            ...
            rotations:
                enableRotation ? [0, 180, 180, 90, 0] : [-1, -1, -1, -1, -1],
            image: image,
            imageSize: calculatePixel(int.parse(distance), '6/9.5'),
            language: widget.image),
        ChartItemLogmar(
            textLeft: '6/7.5',
            textRight: '0.1',
            rotations:
                enableRotation ? [0, 180, 180, 90, 0] : [-1, -1, -1, -1, -1],
            image: image,
            imageSize: calculatePixel(int.parse(distance), '6/7.5'),
            language: widget.image),
        ChartItemLogmar(
            textLeft: '6/6',
            textRight: '0',
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Container(
                          ...
                          // width: calculatePixel(int.parse(distance), widget.chartItemsList[0].textLeft)*13.8,
                          width: int.parse(distance) > 9
                              ? (calculatePixel(int.parse(distance),
                                      widget.chartItemsList[0].textLeft) *
                                  10)
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[1].textLeft),
                              ),
                              Container(
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[2].textLeft),
                              ),
                              SizedBox(
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[3].textLeft),
                              ),
                              SizedBox(
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[4].textLeft),
                              ),
                              SizedBox(
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[5].textLeft),
                              ),
                              SizedBox(
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[6].textLeft),
                              ),
                              SizedBox(
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[7].textLeft),
                              ),
                              SizedBox(
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[8].textLeft),
                              ),
                              SizedBox(
                              ...
                              SizedBox(
                                height: calculatePixel(int.parse(distance),
                                    widget.chartItemsList[9].textLeft),
                              ),
                              SizedBox(
